    ...
    public class HDD_Manager : MonoBehaviour
    {
        ...
        public async Task Refresh()
        {
            ...
            for (var i = 0; i < reply.Infos.Count; ++i)
            {
                ...
                Logger.Log(
                    $"display {i}: {width}x{height}, name={info.Name}, primary={info.IsPrimary}"
                );
            }
        ...
        public Shremdup.DisplayInfo primaryInfo =>
            this.primaryIndex >= 0 ? this.Monitors[this.primaryIndex] : null;
    }
}
